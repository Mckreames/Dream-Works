...
function Blog({ id, name, artist, songKey, bpm, deleteItem }) {
  return (
    <>
    ...
    <div className="col-12 background">
      <div className="offset-1 col-10">
        <header className="pb-4">
          <h1 className="pt-4 pb-2 dark-frost"> Future Forge Chronicles </h1>
          <h4 className="offset-1 offset-md-4 col-10 col-md-4 pt-2 pb-2 save-your-favorites">
            From Daily Life To Cutting-Edge Engineering
          </h4>
        </header>
